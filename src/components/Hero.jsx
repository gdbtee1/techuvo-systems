      ...
      <div className="relative z-10 w-full px-4 md:px-10">
        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <motion.p
            ...
            className="uppercase tracking-[0.3em] text-xs md:text-sm text-gray-300 mb-5"
          >
          ...
          <motion.p
            ...
            className="mt-6 text-sm sm:text-base md:text-lg text-gray-200 max-w-2xl mx-auto leading-relaxed"
          >
          ...
          >
            ...
            <button className="w-full sm:w-auto bg-white text-black px-7 py-3 rounded-xl font-medium hover:scale-105 transition">
              Start Your Project
            </button>

            <button className="w-full sm:w-auto border border-white px-7 py-3 rounded-xl hover:bg-white hover:text-black transition">
              View Services
            </button>
