        ...
        <div className="h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-10">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium">
              ...
              <Link className="hover:text-gray-500 transition" to="/services">
                Services
              </Link>

              <Link className="hover:text-gray-500 transition" to="/shop">
                Shop
              </Link>
          ...
          {/* RIGHT (NEW CLEAN AGENCY STYLE) */}
          <div className="flex items-center gap-6">

            {/* SEARCH (kept, subtle tool) */}
            <div className="relative">

              <button onClick={() => toggleMenu("search")}>
                <Search size={20} className="hover:scale-110 transition" />
              </button>
            ...
            <Link
              to="/contact"
              className="bg-black text-white px-4 py-2 rounded-xl text-sm hover:scale-105 transition"
            >
              Contact
            </Link>
